    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      {myClubs.length === 0 ? (
        <div className="text-center py-10">
          <h3 className="text-xl font-medium text-gray-700 mb-2">You haven't created any clubs yet</h3>
          <p className="text-gray-500 mb-6">Start by creating your first club!</p>
